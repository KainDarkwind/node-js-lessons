...
const indexOfDomainEmail = email.lastIndexOf(delimiter);
console.log(`The index of domain email is ${indexOfDomainEmail}.`);

const localEmail = email.slice(0, indexOfLocalEmail);
console.log(`The value of local email is ${localEmail}.`);

const domainEmail = email.slice(indexOfDomainEmail + 1);
console.log(`The value of domain email is ${domainEmail}.`);

const password = `mikez123456`;

if (password.includes(localEmail)) {
   console.log(`Password includes local email`);
} else {
   console.log(`Password does not include local email`);
}
